...
using CollectionsResolution.Module.NonPersistentBusinessObjects.Storage;

namespace CollectionsResolution.Module {
    // For more typical usage scenarios, be sure to check out https://documentation.devexpress.com/eXpressAppFramework/clsDevExpressExpressAppModuleBasetopic.aspx.
    public sealed partial class CollectionsResolutionModule : ModuleBase {
        public CollectionsResolutionModule() {
            InitializeComponent();
