...
namespace CollectionsResolution.Module.BusinessObjects.CollectionRendering
{
    ...
    /// </summary>
    public class SubCollectionItemPersistentCustom : BaseObject
    {
        public SubCollectionItemPersistentCustom(Session session) : base(session) { }
        ...
        private CollectionItemPersistentCustom _collectionItem;
        /// <summary>
        /// Gets or sets the parent collection item.
        /// </summary>
        [Association("CollectionItemPersistentCustom-SubItems")]
        public CollectionItemPersistentCustom CollectionItem
        {
            get => _collectionItem;
