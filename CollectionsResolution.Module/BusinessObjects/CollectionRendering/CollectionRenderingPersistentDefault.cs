...
{
    /// <summary>
    /// Persistent object to verify collection rendering with default editors in XAF.
    /// This object contains primitive types and two collections to test default rendering.
    /// </summary>
    public class CollectionRenderingPersistentDefault : BaseObject
    {
        public CollectionRenderingPersistentDefault(Session session) : base(session) { }
